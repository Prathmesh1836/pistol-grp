...
export const PISTOL_STATS: StatItem[] = [
  {
    id: "members",
    label: "Active Bakchods",
    value: 20,
    suffix: "+",
    icon: "Users",
    description: "Just a bunch of friends making college life unforgettable",
  },
  {
    id: "wings",
...
export const PISTOL_WINGS: Wing[] = [
  {
    ...
    fullDesc: "The digital spine of Pistal Group. We build cutting-edge web applications, mobile platforms, and enterprise solutions for real-world campus problems.",
    iconName: "Code2",
  ...
  },
  {
    ...
    fullDesc: "Shaping the aesthetic essence of Pistal Group. We produce high-level UX designs, 3D renders, video teasers, and festival brandings.",
    iconName: "Palette",
...
export const TESTIMONIALS: Testimonial[] = [
  {
    id: "1",
    quote: "Joining Pistal Group was the defining milestone of my college journey. I gained hands-on software experience and built friendships for life.",
  ...
  {
    id: "2",
    quote: "The energy in Pistal Group's robotics lab is electric. You get the freedom to experiment with real hardware and compete nationally.",
    name: "Kabir Mehta",
  ...
  {
    id: "3",
    quote: "Pistal Group isn't just a college group; it's an innovation hub where ideas turn into reality overnight during hackathons.",
    name: "Tanvi Saxena",
